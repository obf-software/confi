...
import { Box, Heading, Text, VStack, SimpleGrid, Card, Stat, HStack, Badge, Alert } from '@chakra-ui/react';
    ...
    <Box>
      <VStack align='stretch' gap='6'>
        <Box>
          ...
          <Text color='fg.muted'>
            Visão geral do sistema e guia de administração
          </Text>
        </Box>
            ...
            <VStack align='stretch' gap='6'>
              ...
              <Box>
                ...
                <HStack gap='2' mb='4' overflowX='auto'>
                  <VStack gap='1'>
                    ...
                    <Text fontSize='xs' fontWeight='semibold'>Buscar</Text>
                  </VStack>
                  
                  <Box flex='1' h='1px' bg='border.default' alignSelf='center' />
                  
                  <VStack gap='1'>
                    <Box p='3' borderRadius='full' bg='purple.100' color='purple.600'>
                      <FiCheckCircle size='20' />
                    </Box>
                    <Text fontSize='xs' fontWeight='semibold'>Revisar</Text>
                  </VStack>
                  ...
                  <VStack gap='1'>
                    ...
                    <Text fontSize='xs' fontWeight='semibold'>Tags</Text>
                  </VStack>
                  
                  <Box flex='1' h='1px' bg='border.default' alignSelf='center' />
                  
                  <VStack gap='1'>
                    <Box p='3' borderRadius='full' bg='purple.500' color='white'>
                      <MdOutlineAutoAwesome size='20' />
                    </Box>
                    <Text fontSize='xs' fontWeight='semibold' color='purple.500'>Avaliar</Text>
                  </VStack>
                  ...
                  <VStack gap='1'>
                    ...
                    <Text fontSize='xs' fontWeight='semibold'>Disponível</Text>
                  </VStack>
                </HStack>

                <SimpleGrid columns={{ base: 1, md: 2, lg: 5 }} gap='4' mt='4'>
                  <Box>
                    <Text fontWeight='semibold' color='fg.emphasized' fontSize='sm'>
                      1. Buscar
                    </Text>
              ...
              <Box>
                ...
                <HStack gap='2' mb='4' justify='center'>
                  ...
                  <Box flex='1' maxW='100px' h='1px' bg='border.default' alignSelf='center' />
                  
                  <VStack gap='1'>
                    <Box p='3' borderRadius='full' bg='blue.100' color='blue.600'>
                      <FiCheckCircle size='20' />
                    </Box>
                    <Text fontSize='xs' fontWeight='semibold'>Selecionar</Text>
                  </VStack>
                  ...
                  <VStack gap='1'>
                    ...
                    <Text fontSize='xs' fontWeight='semibold' color='blue.500'>Planejar</Text>
                  </VStack>
                </HStack>
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} gap='6'>
              <Box>
                ...
                <Text fontSize='sm' color='fg.muted'>
                  Execute buscas regularmente para encontrar novas oportunidades. Revise e aprove antes de disponibilizar aos usuários.
                </Text>
              </Box>
              ...
              <Box>
                ...
                <Text fontSize='sm' color='fg.muted'>
                  Crie tags que representem bem as categorias de oportunidades. Quanto melhores as tags, mais preciso será o matching.
                </Text>
              </Box>
              ...
              <Box>
                ...
                <Text fontSize='sm' color='fg.muted'>
                  Rode o processo de avaliação sempre que houver oportunidades sem tags. Isso garante que usuários encontrem resultados.
                </Text>
              </Box>
              ...
              <Box>
                ...
                <Text fontSize='sm' color='fg.muted'>
                  Acompanhe as estatísticas e planejamentos criados. Ajuste tags e buscas baseado no que os usuários estão procurando.
                </Text>
              </Box>
            </SimpleGrid>
          </Card.Body>
        ...
        <Alert.Root status='info'>
          ...
          <Alert.Content>
            ...
            <Alert.Description>
              Para começar: 1) Crie uma busca de oportunidades, 2) Revise e aprove as encontradas, 3) Crie tags relevantes, 4) Execute uma avaliação. Pronto! O sistema está configurado para os usuários.
            </Alert.Description>
          </Alert.Content>
        </Alert.Root>
      </VStack>
