...
export const DashboardTags: React.FC = () => {
  // Mock data for demonstration
  const tags = [
    { id: '1', name: 'Tecnologia', description: 'Oportunidades relacionadas a tecnologia', count: 45 },
      ...
      <VStack align='stretch' gap='6'>
        <HStack justify='space-between'>
          <Box>
            ...
            <Text color='fg.muted'>
              Gerencie as tags para categorizar oportunidades
            </Text>
          </Box>
